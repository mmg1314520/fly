...
class RtspServer:
    def __init__(self,session_name="face",port=8554,video_type = mm.multi_media_type.media_h264,enable_audio=False):
...
#            display_size=[1280,720]
            ...
            while self.start_stream:
                ...
                yuv420sp_img = self.sensor.snapshot(chn=CAM_CHN_ID_0)
                face_det.draw_result(yuv420sp_img,res)   # 绘制结果
...
if __name__ == "__main__":
    print("连接网络中 ...")
    Connect_WIFI("A203_WIFI", "a203a203")
    print("启动中 ..")
    ...
    sta = network.WLAN(0)
    print("K230 IP:", sta.ifconfig()[0])
    print("RTSP URL:", rtspserver.get_rtsp_url())
    print("启动成功！")
    # 推流60s
    while True:
        time.sleep(60)
